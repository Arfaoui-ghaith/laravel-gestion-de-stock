...
@section('content')
    @include('users.partials.header', ['title' => __('Ajouter cahier')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('cahier.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('Chef_projet') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Chef_projet" id="input-Chef_projet" class="form-control form-control-alternative{{ $errors->has('Chef_projet') ? ' is-invalid' : '' }}" placeholder="{{ __('chef de projet') }}" value="{{ old('Chef_projet') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('fournisseur') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="browser-default custom-select form-control form-control-alternative{{ $errors->has('fournisseur') ? ' is-invalid' : '' }}" name="fournisseur" id="input-fournisseur" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_lancement" id="input-date_lancement" class="form-control form-control-alternative{{ $errors->has('date_lancement') ? ' is-invalid' : '' }}" placeholder="{{ __('date_lancement') }}" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="observation" id="input-observation" class="form-control form-control-alternative{{ $errors->has('observation') ? ' is-invalid' : '' }}" placeholder="{{ __('observation') }}" value="" required>

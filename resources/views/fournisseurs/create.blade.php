...
@section('content')
    @include('users.partials.header', ['title' => __('Add fournisseur')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('fournisseur.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('numero') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="numero" id="input-numero" class="form-control form-control-alternative{{ $errors->has('numero') ? ' is-invalid' : '' }}" placeholder="{{ __('numero') }}" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code_postal" id="input-code_postal" class="form-control form-control-alternative{{ $errors->has('code_postal') ? ' is-invalid' : '' }}" placeholder="{{ __('code postal') }}" value="" required>
